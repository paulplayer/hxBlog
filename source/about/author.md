...
{% img /gallery/about/about-me.jpg 800 Paul Zhang %}
...
男 | 32岁 | 汉族 | 户口：北京 | 籍贯：石家庄 | 党员 | 退役军人 | 硕士 | 7年经验
...
**2015.12-2017.12 军事科学院系统工程研究院（总体所） 研究实习员**
*总体所（原武器装备论证研究中心）为装备发展部直属单位，研究室为xx合格产品名录的管理单位，负责xx软硬件产品的试验鉴定工作，并为xx机关提供该领域需求论证、总体规划等专家咨询能力。*
- 主要负责执行具体试验测评工作，如编制试验大纲、编写测试用例，并具体测试了多款国产操作系统、数据库、办公软件等产品，承担栅格化信息网络测试等全军重大专项任务；
- 参与《xx合格产品名录》的管理工作，负责企业申请进名录的对接及管理，并协助上级机关编制新版自主可控产品名录；
- 参与xx计算机基础软件相关产品的规划论证工作、及xx标准规范的编制及修订工作；
担任研究室安全保密管理员，负责研究室的涉密材料的管理工作，研究室当年获所内安全保密先进单位荣誉。
期间，借调中央军委xx机关工作一年，担任机关参谋、“十三五”军用计算机专家组秘书等职务。

**2017.12-2020.10 军事科学院系统工程研究院（网信所） 助理工程师**
*负责xx软硬件产品的试验鉴定工作，并为xx机关提供该领域需求论证、总体规划等专家咨询能力。*
- 主要负责新版《xx自主可控产品名录》的编制与管理工作，负责企业申请进名录的对接及管理，负责组织实施对相关企业所申报的具体型号产品的进行软件测评、试验鉴定等工作；
- 负责xx共性基础软件方向相关课题申请与承研，并作为使用总体与国防科大等操作系统领域优势单位联合承接《xx操作系统》型号研制项目相关工作；
- 负责“十三五”xx计算机与共性软件支撑技术方向预研课题指南的规划论证工作，担任xx计算机及共性基础软件专业组秘书（组长为廖湘科院士），负责联络、对接、组织该专业组相关专家进行该方向预研课题的规划论证、指南编制、评审等工作。

**2020.10-2022.10 京东集团（企业业务事业部） 产品经理**
*部门为事业部数据中台部门，负责为整个事业部提供数智化支撑能力，基于京东大数据管理平台，为内部相关系统提供大数据及算法能力，为外部客户提供大数据相关产品。*
- 负责事业部流量主题相关数据资产建设，完成从0到1搭建事业部流量数据自动化处理pipeline。包括埋点需求管理、埋点方案制定、埋点数据验证、埋点数据修复、埋点上报后加工处理及可视化等全链路数据开发，及路径树等流量跟单模型方案设计。为后续业务分析客户行为画像，指导业务部门运营活动资源投放提供重要数据支持；
- 负责事业部商品主题相关数据及算法模型建设，并沉淀成商品标签等数据资产。负责商品基础标签、规则标签、以及算法标签生产及应用，负责标签画像、A/B实验等方案设计，赋能业务对商品价格、库存、商品池、寻源等智能化管理；
- 负责针对京东企业业务供应商的对外数据产品（京东商智企业端）建设，与宝洁、联想等品牌合作，在京东商智内嵌入企业端数据产品，帮助企业业务与供应商之间建立通畅高效的数据信息通路，让供应商可以更加快速的响应B端需求。

---

#### 项目经历
项目经验丰富，直接参与过xx重大专项、核高基、xx预研、xx型号，以及xx军内科研等多项国家和部队项目，也在企业中完成过多个商业产研项目。典型项目举例如下：
- 2012年，本科生国家级创新项目《安全云存储项目》，结题优，主要负责人，实际完成人；
- 2013年，国防科技大学信息系统与管理学院网上荣誉室建设，主要负责人，实际完成人；
- 2014年，基于脉搏血氧计的便携式睡眠呼吸（OSAHS疾病）监测诊断系统，主要参与人，实际完成人；
*面向OSAHS疾病初筛诊断，与北京德海尔医疗公司和华西医院合作，基于指尖PPG信号进行OSAHS疾病监测诊断，结果比该公司引进的以色列产品效果提升10%，成果发表SCI期刊，并成功部署到商业平台使用。*
- 2015 - 2020，直接参与过xx重大专项、核高基、xx预研、xx型号，以及xx军内科研等多项国家和部队项目；
*按保密规定，仅列出重点项目名称，xx栅格化信息网测试项目，xx自主可控试验床项目（TPC-C/H Benchmark 测试）、xx自主可控计算机型号研制项目、《xx关键软硬件自主可控产品名录（2019年版）》项目、xx操作系统型号研制项目、《“十三五”xx计算机与共性软件支撑技术方向预研课题指南》等。*
- 2020.11 - 2021.03，京东商智（品牌版）企业端数据项目，产品经理；
*京东商智是京东集团的No.1级别数据产品，本项目是与京东商智品牌版合作，在其内嵌入企业端数据产品。旨在打通企业业务与供应商之间的合作壁垒，建立通畅高效的数据信息通路，让供应商快速响应B端需求，明确在企业业务的重点商品、销量、价格等，为企业业务单独备货，减少缺货和无货的商品数量。*
- 2021.03 - 2021.09，京斗云项目（企业业务流量数据建设），产品经理；
*京东内部B端流量数据基础薄弱，埋点、模型、指标均有不同程度的缺失，导致在分析用户站内行为的时候存在数据断层，本项目为流量数据建设项目，核心内容包括埋点需求管理、埋点方案制定、埋点数据验证、埋点数据修复、埋点上报后加工处理及可视化等全链路数据开发，完成了从0到1搭建自动化埋点验证及处理pipeline，让流量数据真正成为业务“指明灯”。*
- 2022.03 - 2022.06，京斗云项目2期，产品经理；
- 2022.03 - 2022.06，企业业务数据标签专项，产品经理；
*数据标签项目被称为京东零售的二次革命，旨在为京东零售运营效率带来质的飞跃，其以流量侧为牵引，全流程自动化为建设方向，多方协同，通过统一标签语言体系及运营流程建设，最终提升标签质量，提升标签运营效率和流量场的效果体验。*
...
- 获大学生数学建模竞赛国际一等奖、信息安全竞赛全国二等奖、机器阅读竞赛全国二等奖等省部级以上奖励7项；
- 发表SCI论文6篇，EI论文4篇，中文期刊4篇，硕士毕业论文获湖南省优秀硕士毕业论文；
- 承担大学生国家级创新项目1项（结题优）；
- 获部队嘉奖2项；

##### 2020-至今

- 获2020年度集团内黑客马拉松竞赛前15（队长，350+参赛队）；
- 获2020年度事业部最佳新人奖；
- 获2021年度事业部企项奖最佳项目奖（主要成员）；
...
工程背景出身，熟悉软件开发、测试相关的理论和方法，具有产品经理与项目管理实际经验，具备快速学习并掌握所在企业的业务领域知识的能力；
部队出身，后从业互联网公司，熟悉部队机关、科研院所、及军工集团等单位业务模式及办公方式，熟悉互联网公司业务模式及办公方式，具备交叉视野，及资源互补优势；
